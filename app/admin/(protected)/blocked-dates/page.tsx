  ...
  return (
    <div className="p-6 max-w-5xl">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-semibold text-gray-900">Blocked Dates</h1>
          <p className="text-sm text-gray-500 mt-0.5">Block dates to prevent new online bookings</p>
        </div>
        <button
